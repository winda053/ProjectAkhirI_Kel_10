								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1>Thankyou </h1>
											<hr/>
											<p>Hello <?php echo "<b>".$_SESSION["name"]."</b>"; ?>,Halo Pembelian anda sendang di proses mohon tunggu pesanan anda
											Untuk pembayaran segera anda bisa transfer ke no bank berikut<b><?php echo $trx_id; ?></b><br/>
