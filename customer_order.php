...
<html>
	<head>
		<meta charset="UTF-8">
		<title>EcommeKoperasi IT Del</title>
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Name Product</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Harga Product</td><td><b><?php echo  CURRENCY." ".$row["product_price"]; ?></b></td></tr>
													<tr><td>jumlah Product</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
