	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li><a href="produk.php"><span class="glyphicon glyphicon-modal-window"></span> Produk</a></li>
							...
							<div class="panel panel-primary">
								...
								<div class="panel-heading">
									<form onsubmit="return false" id="login">
										...
										<a href="customer_registration.php?register=1" style="color:white; text-decoration:none;">Buat Akun Baru</a>
									</form>
								</div>
					...
					<div class="panel-body">
						...
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								...
								<div class="panel-heading">Rp.500.00
