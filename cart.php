				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-md-2 col-xs-2"><b>Gambar Product</b></div>
							<div class="col-md-2 col-xs-2"><b>Nama Product</b></div>
						...
						<!--<div class="row">
							...
							<div><a href="checkout.php" class="btn btn-primary">Checkout</a></div>
						</div>
					</div>
